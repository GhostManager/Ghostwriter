...
(function () {
    ...
    window.cvssv4Score = function (cvssSelected) {
        ...
        if (eq3 == 0 && eq6 == 0) {
            ...
            const score_eq3eq6_next_lower_macro_left = cvssLookup_global[eq3eq6_next_lower_macro_left]
            const score_eq3eq6_next_lower_macro_right = cvssLookup_global[eq3eq6_next_lower_macro_right]
            ...
            score_eq3eq6_next_lower_macro = cvssLookup_global[eq3eq6_next_lower_macro]
        }
        ...
        const eq3_eq6_maxes = getEQMaxes(macroVectorResult, 3)[macroVectorResult[5]]
        ...
        let severity_distance_AV, severity_distance_PR, severity_distance_UI, severity_distance_AC, severity_distance_AT, severity_distance_VC, severity_distance_VI, severity_distance_VA, severity_distance_SC, severity_distance_SI, severity_distance_SA, severity_distance_CR, severity_distance_IR, severity_distance_AR;
