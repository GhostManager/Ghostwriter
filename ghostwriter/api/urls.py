...
urlpatterns = [
    ...
    path("getAcronyms", csrf_exempt(GraphqlGetAcronymsAction.as_view()), name="graphql_get_acronyms"),
    path(
    ...
    path("downloadEvidence", csrf_exempt(GraphqlDownloadEvidence.as_view()), name="graphql_download_evidence"),
