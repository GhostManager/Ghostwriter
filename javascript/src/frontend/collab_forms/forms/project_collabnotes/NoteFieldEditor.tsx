...
export default function NoteFieldEditor({
    ...
    return (
        <div ref={setNodeRef} style={style} className="note-field-wrapper">
            <div className="note-field-header d-flex align-items-center gap-2 mb-2">
                <button
                    {...attributes}
                    {...listeners}
            ...
            {field.fieldType === "rich_text" ? (
                ...
                <ImageField
                    ...
                    onDelete={onDelete}
                    onUpload={
                        onUploadImage ? (file: File) => onUploadImage(field.id, file) : undefined
                    }
