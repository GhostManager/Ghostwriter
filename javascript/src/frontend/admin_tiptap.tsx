import { Editor, EditorProvider, useCurrentEditor, useEditor, useEditorState } from "@tiptap/react";
...
function RichTextEditor(props: {
    ...
    return (
        <div className="collab-editor">
            ...
            >
                <HtmlInputElement name={props.name} initial={props.initial} id={props.id} />
            </EditorProvider>
        </div>
    );
}
...
function HtmlInputElement(props: {
    ...
    const updateHtml = useCallback(({editor}: {editor: Editor}) => {
...
(window as any).gwSetupTiptapEditor = (el: HTMLElement, name: string, id: string, initial: string) => {
