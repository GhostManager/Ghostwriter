...
An operator can set a **Report Email Address** under **Profile → Personal information** when the address shown to clients differs from their account or SSO email address. Project and report exports use that address for the operator's team entry. If it is blank, exports use the account email address.
