...
| `business_days(start_date, end_date) | Provide two datetime objects and calculate the amount of business days between them. **Example:** `datetime(2025, 12, 1) \| business_days(datetime(2025, 12, 12))` return 10 |
