...
* Ghostwriter CLI binaries for Windows, macOS, and Linux

### Changed

* Docker will now use one _.env_ file with variable values for all environments
  * The file is generated by Ghostwriter CLI
* Ghostwriter CLI will now be used for installation, configuration, and management the Ghostwriter server
